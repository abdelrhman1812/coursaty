...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (offset > 50 || isLoginOrRegister) {
        setScrolled(true);
      } else {
        setScrolled(false);
      }
  ...
  }, [location]); // التحقق عند تغيير المسار
    ...
    >
      <div className="container-xxl pb-1">
        ...
        <span
          ...
          className=" d-block d-lg-none  fa fa-bars text-info fs-4"
          type="button"
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
          ...
          <div className="dropdown">
            ...
            >
              <li>
                <Link className="dropdown-item fw-bold" to="/account/user">
                  {" "}
                  الملف الشخصي مستخدم
                </Link>
              </li>
              <li>
                <Link className="dropdown-item fw-bold" to="/account/teacher">
                  الملف الشخصي مدرس
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link className="dropdown-item text-danger fw-bold" to="/login">
                  تسجيل الخروج
                </Link>
              </li>
            </ul>
