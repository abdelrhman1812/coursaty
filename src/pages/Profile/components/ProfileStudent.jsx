                    ...
                    <div className="col-md-4">
                        ...
                        <div className="card shadow-lg border mb-4 mb-xl-0">
                            ...
                            <div className="card-body text-center">
                                ...
                                <button className="BTN" type="button">تحميل صورة جديدة</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card shadow-lg border mb-4">
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    {/* Save changes button */}
                                    <button className="BTN" type="button">حفظ التغييرات</button>
                                </form>
                            </div>
                        </div>
                        ...
                        <div className="card shadow-lg border mb-4">
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    <button className="BTN" type="button">حفظ</button>
                                </form>
                            </div>
                        </div>
                        {/* Delete account card */}
