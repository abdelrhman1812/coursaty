...
const ProfileStudent = () => {
  ...
  return (
    <section className="m-0 user-profile ">
          ...
          <div className="col-md-4">
            ...
            <div className="card shadow-lg border mb-4 mb-xl-0">
              ...
              <div className="card-body text-center">
                ...
                <img
                  className="img-account-profile rounded-circle w-50 mb-2"
            ...
            <div className="card  shadow-lg border mb-4">
              ...
              <div className="card-body">
                <p className="text-danger">
                  تحذير: حذف حسابك هو إجراء لا يمكن التراجع عنه. ستفقد جميع
                  بياناتك وسيتعذر عليك الوصول إلى حسابك مرة أخرى.
                </p>
