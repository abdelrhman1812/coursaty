      ...
      <nav className="nav nav-borders py-3">
        <div className="container-xxl d-flex align-items-center justify-content-between">
          <div className="d-none d-md-flex">
            <NavLink className="nav-link  ms-0 text-white" to={"/account/user"}>
              الملف الشخصي
            </NavLink>
            <NavLink className="nav-link  ms-0 text-white" to={"/account/user"}>
              كورساتي
            </NavLink>
            <NavLink className="nav-link  ms-0 text-white" to={"/"}>
              الرئيسية
            </NavLink>
          </div>
          <div className="dropdown mx-auto mx-md-0">
            ...
            >
              ...
              <li>
                <NavLink
                  className="nav-link d-block d-md-none  ms-0 "
                  to={"/account/user"}
                >
                  الملف الشخصي
                </NavLink>
              ...
              <li>
                <NavLink className="nav-link d-block d-md-none ms-0 " to={"/"}>
                  الرئيسية
                </NavLink>
              </li>
            </ul>
