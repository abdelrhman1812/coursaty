...
export default function Login() {
    ...
    return (
        <div className="login register d-flex justify-content-center align-items-center min-vh-100 py-5" dir="rtl">
            <div className="container">
                <div className="row g-0">
                    <div className="col-lg-6 mx-auto bg-light p-3 rounded-5">
                        ...
                        <h2 className='fw-bold text-center mt-0' data-aos="fade-right" data-aos-duration="1000">تسجيل الدخول</h2>
                        ...
                        <form onSubmit={formik.handleSubmit} data-aos="fade-right" data-aos-duration="1000">
                            ...
                            <div className='mb-3 position-relative'>
                                ...
                                <i ref={eye} onClick={displayEye} className="fa-solid mx-2 fa-eye position-absolute top-50 start-0 translate-middle-y d-none"></i>
                            </div>
                            {!formik.errors.password && formik.touched.password && <span className='text-success fw-bold'><i className="fa-solid fa-circle-check mx-2 mt-1"></i>كلمة المرور صحيحة</span>}
                        ...
                        <div className='text-center mt-3'>
                            ...
                            <Link to='/register' className='fw-bold'>إنشاء حساب جديد</Link>
                        </div>
                    </div>
                </div>
            </div>
