...
const CourseDetails = () => {
    const courseId = 1; // تأكد من استخدام ID حقيقي عند التكرار من بيانات ديناميكية
                ...
                <div className="row m-0 g-5 border-bottom">
                    <div className='row g-3 my-3'>
                        <div className="col-md-8">
                            <IntroVideo
                                videoIntro={courseDetails.videoIntro}
                            />
                        </div>
                        <div className="col-md-4">

                            {/* <CourseImage
                                imgSrc={courseDetails.image}
                                altText={`Image for ${courseDetails.title}`}
